...
export default function AccordionDash() {
  ...
  return (
    <div>
      ...
      <Box height={30} />
       <Typography gutterBottom variant="h6" component="div" sx={{ display: 'flex', justifyContent: 'center', alignItems: 'bottom' ,color: '#022960' }} onClick={()=>{navigate("/List")}}>Voir plus </Typography>
    </div>
  );
}
